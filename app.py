...
roles = ['红1','红2','蓝1','蓝2','X']
cards = [ \
    '上忍1','上忍2','上忍3','上忍4','上忍5','上忍6',\
    '密探1','密探2','密探3','密探4','密探5','密探6',\
    '隐士1','隐士2','隐士3','隐士4','隐士5','隐士6',\
    '盲眼刺客1','盲眼刺客2','盲眼刺客3','盲眼刺客4','盲眼刺客5','盲眼刺客6',\
    '百变者(骗徒1)','掘墓人(骗徒2)','捣蛋鬼(骗徒3)','灵魂商贩(骗徒4)','窃贼(骗徒5)','裁判(骗徒6)',\
    '还诗僧','殉道者','首脑'
    ]
discard_pile = []  # 弃牌堆
